...
This component can be used to apply a damage over time to the player when they are in a area. The area can
...
This component works really well with the Player Healthbar component so the player can see
